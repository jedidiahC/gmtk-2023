...
public class Room : MonoBehaviour
{
    ...
    [SerializeField] private List<Breaker> breakers;
    ...
    public List<Breaker> Breakers { get { return breakers; } }
    public bool HasBreaker { get { return breakers.Count > 0; }}
    ...
    private void Awake()
    {
        ...
        breakers.AddRange(GetComponentsInChildren<Breaker>());
